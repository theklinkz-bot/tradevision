...
export const MetricDrilldown = ({
  ...
  const panel = open ? createPortal(
    <span
      ...
      id={id}
      role="tooltip"
      className="metric-drilldown-panel fixed z-[9999] block overflow-auto rounded-md border border-brand-accent/30 bg-brand-bg/95 p-3 text-left shadow-[0_0_24px_rgba(217,119,87,0.10)] backdrop-blur-md animate-in fade-in zoom-in-95 duration-100"
